...
// Extended list shown on Home Section 8 tile grid.
export const homeIndustryTiles = [
  { label: 'Manufacturing',                           icon: 'factory' },
  { label: 'Warehouse & Distribution',                icon: 'package' },
  { label: 'Real Estate & Property Management',       icon: 'building' },
  { label: 'Construction & Skilled Trades',           icon: 'hard-hat' },
  { label: 'Recycling & Waste Management',            icon: 'recycle' },
  { label: 'Logistics & Supply Chain',                icon: 'truck' },
  { label: 'Financial Institutions & Banking',        icon: 'landmark' },
  { label: 'Energy & Infrastructure',                 icon: 'zap' },
