...
export const Card = React.forwardRef(function Card({ className, ...props }, ref) {
  return (
    <div
      ref={ref}
      className={cn('rounded-2xl border border-tp-fog bg-white text-tp-dark shadow-tp-soft', className)}
      {...props}
    />
  );
});
...
export const CardTitle = React.forwardRef(function CardTitle({ className, ...props }, ref) {
  return (
    <h3
      ref={ref}
      className={cn('font-display text-xl font-bold tracking-display-tight leading-snug', className)}
      {...props}
    />
  );
});
...
export const CardDescription = React.forwardRef(function CardDescription({ className, ...props }, ref) {
  return <p ref={ref} className={cn('text-sm text-tp-dark/65 leading-relaxed', className)} {...props} />;
});
